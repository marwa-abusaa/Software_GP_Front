...
class CustomHomePage extends StatefulWidget {
  ...
  final token;
  const CustomHomePage({@required this.token,Key? key}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Score: 10',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold,color: score),
                ),
                ...
                const Row(
                  children: [
                    ...
                    Text.rich( // Start of Text.rich for styled text
                      TextSpan( // Start of TextSpan
                        text: 'Created Stories: ', // Text before the number
                        style: const TextStyle(color: Color.fromARGB(255, 111, 111, 111),fontSize: 15,fontWeight: FontWeight.bold,fontFamily: 'Times New Roman'), // Default text style
                        children: <TextSpan>[  // Start of children TextSpan
                          TextSpan(
                            text: '5', // The number (5) that will have a different style
                            style: const TextStyle(
                              color: score, // Change the color of the number to red
                  ...
                  children: [
                    ...
                    Text.rich( // Start of Text.rich for styled text
                      TextSpan( // Start of TextSpan
                        ...
                        style: const TextStyle(color: Color.fromARGB(255, 111, 111, 111),fontSize: 14,fontWeight: FontWeight.bold,fontFamily: 'Times New Roman'), // Default text style
                        children: <TextSpan>[  // Start of children TextSpan
                          TextSpan(
                            text: '5', // The number (5) that will have a different style
                            style: const TextStyle(
